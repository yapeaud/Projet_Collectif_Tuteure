                ...
                <form action="/sem/dashboard/note" method="post">
                    ...
                    <section class="form-row mt-4">
                        ...
                        <article class="form-group col-md-6">
                            ...
                            <select name="choixTuteur" id="input2"  class="form-control">
                                <option selected>Choisir un tuteur</option>
                                <option>KOUASSI Marius</option>
                                <option>YAO Koffi</option>
                    ...
                    <section class="form-row">
                        <article class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="input2" placeholder="La note/4" name="note1">
                        </article>
                        <article class="form-group col-md-6">
                            <label for="input2">Respect des consignes des réunions et de l'administration</label>
                            <input type="number" class="form-control" id="input3" placeholder="La note/4" name="note2">
                        </article>
                    </section>
                    <section class="form-row">
                        <article class="form-group col-md-6">
                            <label for="input4">Respect du calendrier du PCT </label>
                            <input type="number" class="form-control" id="input4" placeholder="La note/4" name="note3">
                        </article>
                        <article class="form-group col-md-6">
                            <label for="input5">Création des fichiers Drive de gestion du PCT / Notation continue des étudiants</label>
                            <input type="number" class="form-control" id="input5" placeholder="La note/4" name="note4">
                        </article>
                    </section>
                    <section class="form-row">
                        <article class="form-group col-md-6">
                            <label for="input6">Evaluation des rapports des étudiants et feedback</label>
                            <input type="number" class="form-control" id="input6" placeholder="La note/4" name="note5">
                        </article>
                        <article class="form-group col-md-6">
                            <label for="input7">Total</label>
                            <input type="number" class="form-control" id="input7" placeholder="La note/20" name="note6">
                        </article>
                    </section>

    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active">
                    <a href="/etudiant/dashboard"> <i class="menu-icon fa fa-dashboard"></i>Tableau de bord </a>
                </li>

                <h3 class="menu-title">Évaluation</h3><!-- /.menu-title -->
                <li class="menu-item">
                    <a href="/etudiant/dashboard/evalue/membre"> <i class="menu-icon fa fa-laptop"></i>Membres de leur groupe</a>
